...
Los archivos quant.sf fueron importados posteriormente en R mediante tximport y analizados con DESeq2 para realizar el análisis de expresión diferencial. Abrimos RStudio
